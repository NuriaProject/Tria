...
Definitions::Definitions (const QString &fileName)
...
QByteArray Definitions::toByteArray (const QString &string) {
	return QByteArrayLiteral ("QByteArrayLiteral (\"") + string.toUtf8 () + QByteArrayLiteral ("\")");
}

bool Definitions::generate (QIODevice *device) {
...
int Definitions::registerString (const QString &string) {
...
QByteArray Definitions::stringAcessor (const QString &string) {
...
void Definitions::writeHeader (QIODevice *device) {
	device->write ("/*******************************************************************************\n"
...
void Definitions::writeStringBuffer (QIODevice *device) {
...
void Definitions::writeRegisterMetatypeForClass (const ClassDef &def, QIODevice *device) {
...
void Definitions::writeRegisterMetatype (const QString &type, QIODevice *device) {
...
void Definitions::writeDeclareMetatypeForClass (const ClassDef &def, QIODevice *device) {
...
void Definitions::writeDeclareMetatype (const QString &type, QIODevice *device) {
...
void Definitions::writeMemberConverters (const ClassDef &def, QIODevice *device) {
...
void Definitions::writeMemberConverter (const ConversionDef &def, QIODevice *device) {
...
void Definitions::writeStaticConverter (const ConversionDef &def, QIODevice *device) {
	QByteArray from = escapeName (def.fromType);
	QByteArray to = escapeName (def.toType);
...
void Definitions::writeInstantiorClass (QIODevice *device) {
...
void Definitions::writeConversionRegisterers (const ClassDef &def, QIODevice *device) {
	if (!def.hasValueSemantics) {
		return;
	}
...
void Definitions::writeClassDef (ClassDef &def, QIODevice *device) {
	QByteArray prefix = identPrefix (this->m_fileName);
...
void Definitions::writeDestroyMethod (const ClassDef &def, QIODevice *device) {
...
void Definitions::writeBasesMethod (const ClassDef &def, QIODevice *device) {
...
void Definitions::writeCountMethods (const ClassDef &def, QIODevice *device) {
...
void Definitions::writeAnnotationMethods (const ClassDef &def, QIODevice *device) {
...
void Definitions::writeMethodMethods (const ClassDef &def, QIODevice *device) {
...
void Definitions::writeFieldMethods (const ClassDef &def, QIODevice *device) {
...
void Definitions::writeEnumMethods (const ClassDef &def, QIODevice *device) {
...
void Definitions::writeGateCallMethod (const ClassDef &def, QIODevice *device) {
	Q_UNUSED(def);
...
void Definitions::writeMethodGeneric (const Methods &methods, QIODevice *device, const QByteArray &signature,
...
void Definitions::writeFieldGeneric (const Variables &variables, QIODevice *device, const QByteArray &signature,
				   const QByteArray &defaultResult,
...
void Definitions::writeEnumGeneric (const Enums &enums, QIODevice *device, const QByteArray &signature,
				  const QByteArray &defaultResult,
...
QByteArray Definitions::generateMethodArgumentTester (const ClassDef &def, const MethodDef &m) {
...
QByteArray Definitions::methodToCallback (const ClassDef &def, const MethodDef &m, bool safe) {
	QString requirement = findRequirement (m.annotations);
...
QByteArray Definitions::generateGetter (const ClassDef &def, const VariableDef &var) {
...
QByteArray Definitions::generateSetter (const ClassDef &def, const VariableDef &var) {
